    ...
    <>
      {isComingSoon ? (
        ...
        <>
          <Head>
            <title>
              Home | Muslim Illustrations - Open Source Illustrations of Muslim Character
            </title>
          </Head>
          <Layout>
            <main>
                    ...
                    {({ inView, ref }) => (
                      ...
                      >
                        <Box textAlign={{ md: 'left', base: 'center' }}>
                          ...
                          <Text maxW="512px" mb="8" color="brand.cyanDark">
                            Have you ever had a problem where an illustration you saw was too good
                            to miss out, yet the color didn’t suit your taste? Well, worry no
                            more...! With our Color Picker feature, you can change the color of each
                            of our illustration to suit your exact taste. Sounds awesome? Well, it
                            is...
                          </Text>
                        </Box>
                      </SlideFade>
                      ...
                      >
                        <Box textAlign={{ md: 'left', base: 'center' }}>
                          ...
                          <Text maxW="512px" mb="8" color="brand.cyanDark">
                            ...
                            illustrations without the need of worrying about losing any quaility?
                            SVG is awesome I tell ya...!
                          </Text>
                        </Box>
                        <Box
